export default {
  ...
  study: {
    ...
    import_schema_hint: 'Fichier de schéma à importer, incluant les items et les traductions du formulaire.',
  ...
  form: {
    ...
    import_schema_hint: 'Ficher de schéma à importer, contenant les items et les traductions du formulaire.',
    ...
    upload_options_hint: 'Téléverser des options à partir d\'un fichier.',
    image: 'Image',
    image_hint: 'Définir une image et ses zones de sélection.',
    image_src: 'Source de l\'mage',
    image_src_hint: 'La source de l\'image peut être une adresse ou encodée en base64.',
    image_width: 'Largeur de l\'image',
    image_width_hint: 'Affecte la limite de la zone de sélection.',
    image_height: 'Hauteur de l\'image',
    image_height_hint: 'Affecte la limite de la zone de sélection.',
    ...
    upload_areas_hint: 'Téléverser les zones de sélection à partir d\'un fichier texte.',
