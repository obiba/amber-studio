export default {
  ...
  users: {
    ...
    with_2fa: 'L\'authentification à deux facteurs (2FA) est activée (hautement recommandée).'
  },
  groups: {
    title: 'Groupes',
  ...
  study: {
    ...
    interview_designs_hint: 'Une conception d\'entrevue est une séquence d\'étapes basées sur des formulaires. Les entrevues sont à répondre par les participants définis dans une campagne de collecte de données. L\'entrevue peut-être effectuée par le participant seul ou avec l\'aide d\'un investigateur. Voir la <a href="https://amberdoc.obiba.org/en/latest/studio-user-guide/content/itws.html" target="_blank">documentation sur les conceptions d\'entrevues</a> et le <a href="https://amberdoc.obiba.org/en/latest/studio-user-guide/cookbook/interviews/" target="_blank">livre de recettes pour les entrevues</a>.',
    add_interview_design_hint: 'Ajouter une conception d\'entrevue',
    interview_records: 'Enregistrement d\'entrevues',
    interview_records_hint: 'Les données des entrevues sont saugardées à chaque étape de l\'entrevue. Voir la <a href="https://amberdoc.obiba.org/en/latest/studio-user-guide/content/itw-records.html" target="_blank">documentation sur les enregistrements d\'entrevues</a> et le <a href="https://amberdoc.obiba.org/en/latest/studio-user-guide/cookbook/interviews/" target="_blank">livre de recettes pour les entrevues</a>.',
    ...
    view_interview_data_hint: 'Voir les données de l\'entrevue',
    edit_interview_hint: 'Éditer l\'entrevue',
    interview_filling_date: 'Date de remplissage',
    interview_filling_date_hint: 'Date à laquelle le questionnaire a été rempli (manuellement par exemple), si différent de la saisie électronique.',
    edit_interview_filling_date_hint: 'Éditer la date de remplissage de l\'entrevue',
  ...
  chart: {
    cumulated_case_reports: 'Nombre cumulé de rapports de cas',
  ...
  form: {
    ...
    schema: 'Schéma',
    preview: 'Prévue',
    preview_data: 'Prévue des données',
  ...
  interview: {
    ...
    campaign_completion: 'Redirection de fin',
    campaign_completion_hint: 'URL de redirection à la fin de l\'entrevue. Si non renseignée, le participant restera dans l\'application Amber Visit.',
    ...
    campaign_walkin_participants: 'Participants auto-enregistrés',
    ...
    campaign_walkin_visit: 'URL de Amber Visit pour les participants anonymes',
    campaign_walkin_visit_hint: 'URL de Amber Visit à utiliser pour les participants volontaires.',
    campaign_notify_on_interview_completion: 'Notifier la fin de l\'entrevue',
    campaign_notify_on_interview_completion_hint: 'Envoyer une notification aux investigateurs lorsqu\'un participant termine son entrevue.',
    participant_walkin: 'Auto-enregistré',
    ...
    participant_eligibility: 'Éligibilité du participant',
    any_eligibility: '(tous)',
    eligible: 'Éligible',
