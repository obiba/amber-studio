export default {
  ...
  interview: {
    ...
    step_name_hint: 'Nom unique qui servira pour groupes les données collectées durant cette étape.',
    step_definition: 'Définition',
    step_rendering: 'Rendu',
    step_time_estimate: 'Estimation de temps',
    step_time_estimate_hint: 'Temps estimé pour répondre aux questions de cette étape, en minutes, optionnel.',
    ...
    campaign_investigators_hint: 'Les investigateurs auront la charge de gérer l\'activité des participants.',
    ...
    participant_valid_from_hint: 'Date à partir de laquelle l\'invitation du participant est effective. Si non renseigné, l\'invitation est effective immédiatement.',
    participant_valid_until: 'Valide jusqu\'à',
    participant_valid_until_hint: 'Date d\'échéance de l\'invitation. Si non renseigné l\'invitation est opérationelle jsuqu\'à ce que l\'entrevue soit complétée.',
