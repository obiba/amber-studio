export default {
  ...
  study: {
    ...
    interview_designs_hint: 'An interview design is a sequence of steps which are themselves based on forms. The interviews are to be answered by participants defined in data collection campaigns. The interview can be self-administered by the participant or assisted by an investigator. See the <a href="https://amberdoc.obiba.org/en/latest/studio-user-guide/content/itws.html" target="_blank">Interview designs documentation</a> and the <a href="https://amberdoc.obiba.org/en/latest/studio-user-guide/cookbook/interviews/" target="_blank">Interviews cookbook</a>.',
    ...
    view_interview_data_hint: 'View the interview data',
    edit_interview_hint: 'Edit the interview',
    interview_filling_date: 'Filling date',
    interview_filling_date_hint: 'Date on which the questionnaire was filled in (manually for example), if different from electronic entry.',
    edit_interview_filling_date_hint: 'Edit the interview filling date',
  ...
  form: {
    ...
    tr_import: 'Import translations',
    tr_import_hint: 'Upload translations from a text file (.txt, .csv, .tsv).',
    tr_import_file: 'Translations file',
  ...
  interview: {
    ...
    step_time_estimate: 'Time estimate (average or min)',
    step_time_estimate_hint: 'Average or minimum time estimate for answering the questions of this step, in minutes, optional.',
    step_time_estimate_max: 'Time estimate (max)',
    step_time_estimate_max_hint: 'Maximum of time estimate for answering the questions of this step, in minutes, optional.',
    ...
    campaign_completion: 'Redirect on completion',
    campaign_completion_hint: 'URL to redirect to when the interview is completed. If not provided, the participant will stay in the Amber Visit application.',
    ...
    campaign_weeks_info_before_activate: 'Weeks notification before activate',
    campaign_weeks_info_before_activate_hint: 'Send a notification that participant accounts will be activated in this number of weeks. Applies only to participants with an identifier and a start date.',
    ...
    campaign_weeks_info_before_expire: 'Weeks notification before expire',
    campaign_weeks_info_before_expire_hint: 'Send a notification that participant accounts will expire in this number of weeks.',
    ...
    campaign_walkin_participants: 'Self-registered participants',
    campaign_with_walkin_participants: 'Self-registeration',
    campaign_with_walkin_participants_hint: 'Allow walk-in participants to self-register in the campaign.',
    campaign_walkin_url_parameters: 'Self-registeration URL parameters',
    campaign_walkin_url_parameters_hint: 'Amber Visit URL parameters to use for walk-in participants (comma or space separated).',
    campaign_walkin_participant_attributes: 'Self-registered participant attributes',
    campaign_walkin_participant_attributes_hint: 'The pre-fill of the self-registered participant profile.',
