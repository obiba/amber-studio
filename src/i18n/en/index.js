export default {
  ...
  success: {
    ...
    create_study_form: 'Study\'s form form successfully added. Edit to add items.',
  ...
  formel: {
    ...
    description_hint: 'Question help text. If the form is to be translated, provide the translation key.',
    rules: 'Rules',
    rules_hint: 'Validation rules.',
    conditions: 'Conditions',
    conditions_hint: 'Visibility conditions.',
    default: 'Default',
