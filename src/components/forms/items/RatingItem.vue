<template>
  <div class="row q-col-gutter-lg">
    <div class="col-md-6 col-sm-12">
      ...
      <q-input class="q-mb-md" v-model="schema.icon" :label="$t('form.icon')" :hint="$t('form.icon_hint')" :disable="readOnly" />
      <q-input class="q-mb-md" v-model="schema.size" :label="$t('form.size')" :hint="$t('form.size_hint')" :disable="readOnly" />
      <q-input class="q-mb-md" v-model="schema.color" :label="$t('form.color')" :hint="$t('form.color_hint')" :disable="readOnly" />
    </div>
    <div class="col-md-6 col-sm-12">
      ...
      <q-input class="q-mb-md" v-model.number="schema.max" type="number" :label="$t('form.max')" :hint="$t('form.max_hint')" :disable="readOnly" />
    </div>
  </div>
</template>
