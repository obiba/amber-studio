<template>
  <div class="row q-col-gutter-lg">
    ...
    <div class="col-md-6 col-sm-12">
      ...
      <q-input class="q-mb-md" v-model="schema.placeholder" :label="$t('form.placeholder')" :hint="$t('form.placeholder_hint')" :disable="readOnly" />
      ...
      <q-input class="q-mb-md" v-model.number="schema.mask" :label="$t('form.mask')" :hint="$t('form.mask_hint')" :disable="readOnly" />
    </div>
  </div>
</template>
