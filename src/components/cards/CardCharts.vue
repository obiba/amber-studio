...
function init () {
  ...
  const theme = 'light'
  lineChart = echarts.init(lineChartEl, theme)
  lineChart.setOption(LineChart2)

  const barchart = document.getElementById('barchart')
  echarts.dispose(barchart)
  barChart = echarts.init(barchart, theme)
  barChart.setOption(BarChart)

  const linechart = document.getElementById('linechart2')
  echarts.dispose(linechart)
  lineChart2 = echarts.init(linechart, theme)
  lineChart2.setOption(LineChart)
}
